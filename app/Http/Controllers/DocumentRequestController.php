...
class DocumentRequestController extends Controller
{
    ...
    // these correspond to the routes defined in web.php and are used by
    // the Vue/React pages under resources/js/pages/admin/DocumentTypes.tsx
    // ------------------------------------------------------------------
    ...
    public function storeType(Request $request)
    {
        ...
        return back()->with('message', 'Document type created successfully.');
    }
    ...
    public function destroyType($id)
    {
        ...
        return back()->with('message', 'Document type deleted.');
    }
}
